...
final class InputParser {
     ...
     */
    private static final String INPUT_PARSER_NODE_PACKAGE = "io.github.lcenhancer.debugger4j.parser";
        ...
        if (ContainerUtil.isNotEmpty(classesByPackage)) {
            for (Class<?> clazz : classesByPackage) {
                if (ReflectUtil.isExtendsClass(clazz, InputParserNode.class)) {
                    ...
                    InputParserNode inputParserNode = ReflectUtil.createInstance((Class<InputParserNode>) clazz);
