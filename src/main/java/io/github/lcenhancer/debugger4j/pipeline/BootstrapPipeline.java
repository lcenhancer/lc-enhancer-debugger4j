...
import io.github.lcenhancer.debugger4j.printer.OutputPrinterProcessor;
...
/**
 * <p>BootstrapPipeline is a pipeline
 * used to run enhanced pipeline processes.</p>
 * <p>In order to adapt to complex scenarios,
 * BootstrapPipeline takes on
 * more proactive enhancement work here.</p>
 *
 * @author Jidcoo
 * @since 1.0.0
 */
final class BootstrapPipeline extends Pipeline {

    /**
     * Built-in pipeline runner set package location.
     */
    private static final String BUILT_IN_PIPELINE_RUNNER_PACKAGE = "io.github.lcenhancer.debugger4j.pipeline";
    /**
     ...
     */
    private final Map<Integer, Pipeline> pipelineRunnerMap;
    /**
    ...
    /**
     * Create a BootstrapPipeline instance.
     *
     ...
     */
    BootstrapPipeline(LeetcodeJavaDebugEnhancer leetcodeJavaDebugEnhancer,
                      InputProvider inputProvider,
                      OutputConsumer outputConsumer,
                      Object outputPrinter,
                      Object leetcodeExecutor,
                      Object inputParser) {
        ...
        List<Pipeline> builtinPipelineRunners = BeanUtil.collectBeans(Pipeline.class,
                        BUILT_IN_PIPELINE_RUNNER_PACKAGE,
                        klass -> (
                                klass.isAnnotationPresent(Require.class) &&
                                ReflectUtil.isExtendsClass(klass, Pipeline.class) &&
        ...
        for (Pipeline builtinPipelineRunner : builtinPipelineRunners) {
    ...
    private Object doEnhanceAfterInputParseProcess(Object bossLeetcodeExecutor) {
        ...
        Pipeline pipelineRunner = pipelineRunnerMap.get(leetcodeInvoker.getId());
